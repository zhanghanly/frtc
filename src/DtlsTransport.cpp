...
inline static unsigned int onSslDtlsTimer(SSL* /*ssl*/, unsigned int timerUs) {
	...
	{
		{ SrtpSession::CryptoSuite::AEAD_AES_256_GCM, "SRTP_AEAD_AES_256_GCM" },
		{ SrtpSession::CryptoSuite::AEAD_AES_128_GCM, "SRTP_AEAD_AES_128_GCM" },
		{ SrtpSession::CryptoSuite::AES_CM_128_HMAC_SHA1_80, "SRTP_AES128_CM_SHA1_80" },
		{ SrtpSession::CryptoSuite::AES_CM_128_HMAC_SHA1_32, "SRTP_AES128_CM_SHA1_32" }
	};
	// clang-format on
	INSTANCE_IMP(DtlsTransport::DtlsEnvironment);
	//DtlsTransport::DtlsEnvironment& DtlsTransport::DtlsEnvironment::Instance() {
	//	DtlsTransport::DtlsEnvironment::Ptr instance = std::make_shared<DtlsTransport::DtlsEnvironment>();
	//	return *instance;
	//}
   ...
   //             return true;
	...
	inline bool DtlsTransport::ProcessHandshake() {
		...
		SrtpSession::CryptoSuite srtpCryptoSuite = GetNegotiatedSrtpCryptoSuite();
		if (srtpCryptoSuite != SrtpSession::CryptoSuite::NONE) {
	...
	inline void DtlsTransport::ExtractSrtpKeys(SrtpSession::CryptoSuite srtpCryptoSuite) {
		//MS_TRACE();
	...
	inline SrtpSession::CryptoSuite DtlsTransport::GetNegotiatedSrtpCryptoSuite() {
		//MS_TRACE();
		SrtpSession::CryptoSuite negotiatedSrtpCryptoSuite = SrtpSession::CryptoSuite::NONE;
